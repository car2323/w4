...
TimeEntry.create(project_id: row1, hours:4, minutes:30, comment:"ninguno 1er project", date:Time.now - 23.hours)
TimeEntry.create(project_id: row2, hours:1, minutes:0, comment:"ninguno 2do project", date:Time.now - 6.hours)
TimeEntry.create(project_id: row3, hours:4, minutes:30, comment:"ninguno 3er project", date:Time.now - 12.hours)
TimeEntry.create(project_id: row1, hours:3, minutes:15, comment:"ninguno 1er project 2", date:Time.now - 1.hours)
TimeEntry.create(project_id: row1, hours:6, minutes:45, comment:"ninguno 1er project 3", date:Time.now - 12.hours)
